...
/*
@Purpose: This class manage assertions to verify if field has date
@Author: Mibin Boban, CCS Senior QAT Analyst
@Creation: 29/11/2021
*/
public class FieldHasDateAfterValueAsserter implements JsonAsserter {
    ...
    */
    ...
    public FieldAssertionMatcher assertActualToExpected(Object result) {
        ...
        return areEqual ? reportMatchingMessage() : reportNotMatchingMessage(path, "Date After:" + expected, result);
    }
